 ...
 */
class CongVan extends \CongViec\Entity\CongVan implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'ten', 'loai', 'trichYeu', 'noiDung', 'ngayBanHanh', 'ngayHoanThanh', 'ngayHoanThanhThuc', 'ngayTao', 'nguoiTao', 'trangThai', 'cha', 'dinhKems', 'nguoiThucHiens', 'donViTiepNhans');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CongVan $proxy) {
